...
import { VisuallyHidden, SimpleGrid, Input, IconButton } from "@chakra-ui/react"
import {
  Link as LinkChakra,
  Text,
  Box,
...
import MercadoADistanciaSmall from "./svgs/MercadoADistanciaSmall"
      ...
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          <Stack spacing={6}>
            <Box>
              ...
              <Link to="/">
                {/* <MercadoADistancia
                  height="119.999999"
                  width={esUnDispositivoMovil ? "200" : "375"}
                  colorMode={colorMode}
                /> */}
                <MercadoADistanciaSmall colorMode={colorMode} />
              </Link>
            </Box>
            <Text fontSize={"sm"}>
              © 2020 Mercado a Distancia. Todos los derechos reservados
            </Text>
          ...
          <Stack align={"flex-start"}>
            ...
            <Link to="/">Inicio</Link>
            <LinkChakra href={"#"}>Sobre nosotros</LinkChakra>
            <LinkChakra href={"#"}>Contáctanos</LinkChakra>
            <LinkChakra href={"#"}>Ayuda</LinkChakra>
            {/* <LinkChakra href={"#"}>Testimonios</LinkChakra> */}
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>Categorías</ListHeader>
            <LinkChakra href={"#"}>Frutas</LinkChakra>
            <LinkChakra href={"#"}>Verduras</LinkChakra>
            <LinkChakra href={"#"}>Pollo</LinkChakra>
            <LinkChakra href={"#"}>Carne</LinkChakra>
            <LinkChakra href={"#"}>Pescado</LinkChakra>
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>Suscribete con nosotros</ListHeader>
            <Stack direction={"row"}>
              <Input
              ...
              <IconButton
                ...
                color={useColorModeValue(
                  myColors.textBtnLight,
                  myColors.textBtnDark
                )}
                _hover={{
                  bg:
                    colorMode === "light"
                      ? myColors.buttonLightHover
                      : myColors.buttonDarkHover,
                  color:
                    colorMode === "light"
                      ? myColors.textBtnLightHover
                      : myColors.textBtnDarkHover,
                }}
